...
TIME_PER_PROMPT_MURKEY_WATER = 10
TIME_PER_PROMPT_BOAT_HOUSE = 12
TIME_PER_PROMPT_CHAPEL = 12
TIME_PER_PROMPT_LIGHTHOUSE = 15

#Enemy HP bar
ENEMY_HP_BAR_X = WINDOW_WIDTH - 75
ENEMY_HP_BAR_Y = 100
ENEMY_HP_BAR_W = 25
ENEMY_HP_BAR_H = 520
...
#Player Stamina bar
PLAYER_STAMINA_BAR_X = PLAYER_HP_BAR_X + PLAYER_HP_BAR_W + 8
PLAYER_STAMINA_BAR_Y = PLAYER_HP_BAR_Y
PLAYER_STAMINA_BAR_W = 25
PLAYER_STAMINA_BAR_H = PLAYER_HP_BAR_H
